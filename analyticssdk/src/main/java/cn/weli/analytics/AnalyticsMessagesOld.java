...
import cn.weli.analytics.utils.Base64Coder;
 ...
 */
class AnalyticsMessagesOld {

    /**
     * Do not call directly. You should call AnalyticsMessages.getInstance()
     */
    /* package */ AnalyticsMessagesOld(final Context context, final String packageName) {
        mContext = context;
     ...
     */
    public static AnalyticsMessagesOld getInstance(final Context messageContext, final String
            packageName) {
        synchronized (sInstances) {
            final Context appContext = messageContext.getApplicationContext();
            final AnalyticsMessagesOld ret;
            if (!sInstances.containsKey(appContext)) {
                ret = new AnalyticsMessagesOld(appContext, packageName);
    ...
    private static final Map<Context, AnalyticsMessagesOld> sInstances =
            new HashMap<Context, AnalyticsMessagesOld>();
