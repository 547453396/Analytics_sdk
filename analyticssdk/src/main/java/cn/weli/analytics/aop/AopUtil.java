...
//                    viewText =  AopUtil.getViewId(imageView);
    ...
    public static void getFragmentNameFromView(View view, JSONObject properties) {
        try {
            if (view != null) {
                String fragmentName = (String) view.getTag(R.id.analytics_tag_view_fragment_name);
                String fragmentName2 = (String) view.getTag(R.id.analytics_tag_view_fragment_name2);
        ...
        try {
            if (context != null) {
                if (context instanceof Activity) {
                    ...
                    if (view != null) {
                        Object object = view.getTag(R.id.analytics_tag_view_activity);
                        if (object != null) {
    ...
    public static String getViewId(View view) {
        ...
        try {
            idString = (String) view.getTag(R.id.analytics_tag_view_id);
    ...
    public static boolean isViewIgnored(View view) {
        try {
            ...
            //View 被忽略
            if ("1".equals(view.getTag(R.id.analytics_tag_view_ignored))) {
                return true;
            }
