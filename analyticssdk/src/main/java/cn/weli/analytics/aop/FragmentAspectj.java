...
public class FragmentAspectj {
    ...
    private Object trackFragmentView(final ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (result instanceof ViewGroup) {
                ...
                view.setTag(R.id.analytics_tag_view_fragment_name, fragmentName);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            for (int i = 0; i < childCount; ++i) {
                ...
                if (child instanceof ListView ||
                    ...
                    child.setTag(R.id.analytics_tag_view_fragment_name, fragmentName);
    ...
    public void onHiddenChangedMethod(JoinPoint joinPoint) throws Throwable {
        try {
            ...
            if (targetFragment.getClass().getAnnotation(AnalyticsDataIgnoreTrackAppViewScreen.class) != null) {
                return;
            }
    ...
    private void trackFragmentViewScreen(String fragmentName, Activity activity) {
        try {
            if (!AnalyticsDataAPI.sharedInstance().isTrackFragmentAppViewScreenEnabled()) {
                return;
            }
            ...
            AnalyticsDataAPI.sharedInstance().track(EventName.PAGE_VIEW_START.getEventName(), properties);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
